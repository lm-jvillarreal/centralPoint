		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Categorías de mobiliario</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Bienes y patrimonio</a></li>
								<li class="breadcrumb-item active">Categorías de mobiliario</li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Administración de categorías de mobiliario</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
	...
	<script>
		...
		function Tabla() {
			var tabla = $("#example1").DataTable({
				...
				"ajax": {
					type: "POST",
					url: "mobiliarioCategoria/listar",
					dataSrc: "",
					data: "",
				},
				"columns": [{
		...
		$("#btnGuardar").click(function() {
			...
			$.ajax({
				url: "mobiliarioCategoria/insertar",
				type: "POST",
		...
		function lanzarModal(origen, id, categoria, descripcion) {
			if (origen == 'nuevo') {
		...
		$("#btnEliminar").click(function() {
			...
			Swal.fire({
				...
				if (result.isConfirmed) {
					$.ajax({
						url: "mobiliarioCategoria/eliminar",
						type: "POST",
						data: {
							id: id
						},
