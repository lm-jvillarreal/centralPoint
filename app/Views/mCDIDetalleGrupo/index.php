        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Administracion de Detalles</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Grupos</a></li>
                                <li class="breadcrumb-item active">Administracion de Detalles</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#example1 tbody').on('click', ' tr td:nth-child(1)', function() {
                ...
                var grupo = table.cell(rowIdx, 1).data();
                var alumno = table.cell(rowIdx, 2).data();
                lanzarModal("editar", id, grupo, alumno);
            });
        });
        $("#btnGuardar").click(function() {
            removerClass("#frmNuevo");
            $.ajax({
                url: "mCDIDetalleGrupos/insertar",
                type: "POST",
        ...
        function lanzarModal(origen, id, grupo, alumno) {
            if (origen == 'nuevo') {
        ...
        $("#btnEliminar").click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "mCDIDetalleGrupos/eliminar",
                        type: "POST",
                        data: {
                            id: id
                        },
