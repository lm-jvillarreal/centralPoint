                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Administración de puestos de trabajo</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group" id="categoria">
                                                <label for="categoria" class="form-label">*Puesto:</label>
                            ...
                            <div class="modal-footer justify-content-between">
                                ...
                                <button type="button" class="btn btn-secondary" id="btnGuardar">Guardar Puesto</button>
                            </div>
                        </div>
                        <!-- /.modal-content -->
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#example1 tbody').on('click', ' tr td:nth-child(1)', function() {
                ...
                var categoria = table.cell(rowIdx, 1).data();
                var descripcion = table.cell(rowIdx, 2).data();
                lanzarModal("editar", id, categoria, descripcion);
            });
        });
        ...
        function lanzarModal(origen, id, puesto, descripcion) {
            if (origen == 'nuevo') {
                $("#btnEliminar").css('display', 'none');
                limpiar('#frmNuevo');
                $("#modalNuevo").modal("show");
                $("#titulo").html("Catálogo de puestos | Nuevo Registro");
                ...
                $("#modalNuevo").modal("show");
                $("#titulo").html("Catálogo de puestos | Editar Registro");
            }
        }
