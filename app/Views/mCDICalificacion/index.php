...
<body class="hold-transition sidebar-mini">
									...
									<table id="departamentos" class="table table-bordered table-striped">
										<thead>
											<tr>
												...
												<th width='10%'>Practicas</th>
												<th width='10%'>Worbook & HomeWork</th>
												<th width="10%">Quizzes, Exams</th>
												<th width="10%">Proyect</th>
												<th width="10%">Attendancce</th>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="" method="POST" id="frmNuevo">
									<div class="row">
										<div class="col-md-4">
											<div class="form-group" id="Practicas">
												<label for="Practicas" class="form-label">*Practicas:</label>
												<input type="hidden" name="id" id="id">
												<input type="number" name="txt_Practicas" id="txt_Practicas" class="form-control">
												<div class="invalid-feedback"></div>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group" id="Worbook">
												<label for="Worbook" class="form-label">*Worbook & HomeWork:</label>
												<input type="number" name="txt_Worbook" id="txt_Worbook" class="form-control">
												<div class="invalid-feedback"></div>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group" id="Quizzes">
												<label for="Quizzes" class="form-label">*Quizzes, Exams:</label>
												<input type="number" name="txt_Quizzes" id="txt_Quizzes" class="form-control">
												<div class="invalid-feedback"></div>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group" id="Proyect">
												<label for="Proyect" class="form-label">*Proyect:</label>
												<input type="number" name="txt_Proyect" id="txt_Proyect" class="form-control">
												<div class="invalid-feedback"></div>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group" id="Attendancce">
												<label for="Attendancce" class="form-label">*Attendancce:</label>
												<input type="number" name="txt_Attendancce" id="txt_Attendancce" class="form-control">
												<div class="invalid-feedback"></div>
											</div>
										</div>
										<div class="col-md-3">
	...
	<script>
		...
		$('#modalNuevo').on('hidden.bs.modal', function() {
			...
			$("#Practicas > div").html("");
			$("#Practicas > input").removeClass("is-invalid");
			$("#Worbook > div").html("");
			$("#Worbook > input").removeClass("is-invalid");
			$("#Quizzes > div").html("");
			$("#Quizzes > input").removeClass("is-invalid");
			$("#Proyect > div").html("");
			$("#Proyect > input").removeClass("is-invalid");
			$("#Attendancce > div").html("");
			$("#Attendancce > input").removeClass("is-invalid");
			...
			$.ajax({
				...
				statusCode: {
					400: function(xhr) {
						...
						if (resp.Practicas != "") {
							$("#Practicas > div").html(resp.Practicas);
							$("#Practicas > input").addClass("is-invalid");
						}
						if (resp.Worbook != "") {
							$("#Worbook > div").html(resp.Worbook);
							$("#Worbook > input").addClass("is-invalid");
						}
						if (resp.Quizzes != "") {
							$("#Quizzes > div").html(resp.Quizzes);
							$("#Quizzes > input").addClass("is-invalid");
						}
						if (resp.Attendancce != "") {
							$("#Attendancce > div").html(resp.Attendancce);
							$("#Attendancce > input").addClass("is-invalid");
						}
			...
			if (origen == 'nuevo') {
				...
				$.ajax({
					...
					success: function(response) {
						...
						$("#id").val(resp.id);
						$("#txt_Practicas").val(resp.Practicas);
						$("#txt_Worbook").val(resp.Worbook);
						$("#txt_Quizzes").val(resp.Quizzes);
						$("#txt_Proyect").val(resp.Proyect);
						$("#txt_Attendancce").val(resp.Attendancce);
