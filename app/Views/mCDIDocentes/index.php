...
<body class="hold-transition sidebar-mini">
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Catálogo de Docentes</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									<table id="departamentos" class="table table-bordered table-striped">
										<thead>
											<tr>
												...
												<th width='10%'>ApPaterno.</th>
												<th width="10%">ApMaterno</th>
												<th width="10%">NoEmpleado</th>
							...
							<div class="modal-body">
								<form action="" method="POST" id="frmNuevo">
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group" id="NoEmpleado">
												<label for="NoEmpleado" class="form-label">*NoEmpleado:</label>
												<input type="text" name="txt_NoEmpleado" id="txt_NoEmpleado" class="form-control">
												<div class="invalid-feedback"></div>
											</div>
										</div>
										<div class="col-md-3">
	...
	<script>
		...
		$('#modalNuevo').on('hidden.bs.modal', function() {
			...
			$("#NoEmpleado > div").html("");
			$("#NoEmpleado > input").removeClass("is-invalid");
			...
			$.ajax({
				...
				statusCode: {
					400: function(xhr) {
						...
						if (resp.NoEmpleado != "") {
							$("#NoEmpleado > div").html(resp.NoEmpleado);
							$("#NoEmpleado > input").addClass("is-invalid");
						}
			...
			if (origen == 'nuevo') {
				...
				$.ajax({
					...
					success: function(response) {
						...
						$("#txt_ApPaterno").val(resp.ApMaterno);
						$("#txt_NoEmpleado").val(resp.NoEmpleado);
