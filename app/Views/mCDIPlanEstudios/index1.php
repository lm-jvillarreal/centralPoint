...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Administracon de planes</a></li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Catalogo de Plan de Estudios</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="planestudios" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th width='4%'>#</th>
                                                <th width='8%'>Clve</th>
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group" id="periodo">
												<label for="planestudio" class="form-label">*PlanEstudio:</label>
												<input type="hidden" name="id" id="id">
												<input type="text" name="txt_planestudio" id="txt_planestudio" class="form-control">
									...
									<div class="row">
										<div class="col-md-4">
											<div  class="form-group" id="fecha_inicio">
											  ...
											  <input type="date" name="txt_nombre" id="txt_nombre" class="form-control">
											  <div class="invalid-feedback"></div>
											</div>
										</div>
									</div>
    ...
    <script>
        ...
        function Tabla() {
            var tabla = $("#planestudios").DataTable({
                "language": {
        ...
        $(document).ready(function() {
            var table = $('#planestudios').DataTable();

            $('#planestudios tbody').on('click', ' tr td:nth-child(1)', function() {
        ...
        $("#btnGuardar").click(function() {
            ...
            $.ajax({
                url: "mCDIPlanEstudios/insertar",
                type: "POST",
                data: $("#frmNuevo").serialize(),
                success: function(response) {
                    var resp = JSON.parse(response);
                    $("#modalNuevo").modal("toggle");
                    $('#planestudios').DataTable().ajax.reload();
        ...
        function lanzarModal(origen, id, clave, nombre) {
            if (origen == 'nuevo') {
                ...
                limpiar('#frmNuevo');
                $("#modalNuevo").modal("show");
                $("#titulo").html("Catalogo de Planes de Estudio | Nuevo Registro");
            } else if (origen == 'editar') {
                $("#btnEliminar").removeAttr('style');
                $("#id").val(id);
                $("#txt_clave").val(clave);
                ...
                $("#modalNuevo").modal("show");
                $("#titulo").html("Catalogo de Planes de Estudios | Editar Registro");
            }
        }
